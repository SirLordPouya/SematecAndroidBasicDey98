...
public class TestDrawerRecyclerActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_test_drawer_recycler);

        ArrayList<PersonClass> names = new ArrayList<PersonClass>();
        ...
        recycler.setLayoutManager(new LinearLayoutManager(TestDrawerRecyclerActivity.this, RecyclerView.VERTICAL, false));
